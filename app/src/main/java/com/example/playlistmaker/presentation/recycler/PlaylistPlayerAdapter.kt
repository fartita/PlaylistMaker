...
import com.example.playlistmaker.databinding.ItemPlaylistForPlayerBinding
...
class PlaylistPlayerAdapter(
    ...
    RecyclerView.Adapter<PlaylistPlayerAdapter.SmallPlayListViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SmallPlayListViewHolder {
        ...
        return SmallPlayListViewHolder(
            ItemPlaylistForPlayerBinding.inflate(layoutInspector, parent, false),
            filePath
        )
    }
    ...
    class SmallPlayListViewHolder(
        private val binding: ItemPlaylistForPlayerBinding,
